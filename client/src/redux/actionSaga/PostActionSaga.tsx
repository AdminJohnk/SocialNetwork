...
export const SHARE_POST_SAGA = createAction("SHARE_POST_SAGA", (data) => ({payload: data}));
export const UPDATE_POST_SAGA = createAction("UPDATE_POST_SAGA", (data) => ({payload: data}));