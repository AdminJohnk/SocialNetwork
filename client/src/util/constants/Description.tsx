const descArray = [
  {
    ...
    svg: (
      <svg
        ...
        data-prefix="fas"
        data-icon="cloud"
        className="svg-inline--fa fa-cloud text-yellow-600"
  ...
  },
  {
    ...
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="svg-inline--fa fa-chart-line text-green-600"
        viewBox="0 0 20 20"
        fill="currentColor"
        aria-hidden="true"
      >
  ...
  },
  {
    ...
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="svg-inline--fa fa-code text-purple-600"
        viewBox="0 0 20 20"
        fill="currentColor"
        aria-hidden="true"
      >
  ...
  },
  {
    ...
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="svg-inline--fa fa-blog text-blue-600"
        viewBox="0 0 20 20"
        fill="currentColor"
        aria-hidden="true"
      >
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        data-prefix="fas"
        data-icon="comment"
        className="svg-inline--fa fa-comment text-blue-600"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
      >
        <path
          fill="currentColor"
          d="M256 32C114.6 32 .027 125.1.027 240c0 49.63 21.35 94.98 56.97 130.7-12.5 50.37-54.27 95.27-54.77 95.77-2.25 2.25-2.875 5.734-1.5 8.734C1.98 478.2 4.75 480 8 480c66.25 0 115.1-31.76 140.6-51.39C181.2 440.9 217.6 448 256 448c141.4 0 255.1-93.13 255.1-208S397.4 32 256 32z"
        />
      </svg>
    ),
  },
  ...
  },
  {
    ...
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="svg-inline--fa fa-creative-commons-pd text-green-600"
        viewBox="0 0 20 20"
        fill="currentColor"
        aria-hidden="true"
      >
  ...
  },
  {
    ...
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="svg-inline--fa fa-lock text-orange-600"
        viewBox="0 0 20 20"
        fill="currentColor"
        aria-hidden="true"
      >
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        data-prefix="fab"
        data-icon="css3-alt"
        className="svg-inline--fa fa-css3-alt text-blue-600"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 384 512"
      >
        <path
  ...
  },
  {
    ...
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="svg-inline--fa fa-chart-bar text-green-600"
        viewBox="0 0 20 20"
        fill="currentColor"
        aria-hidden="true"
      >
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        className="svg-inline--fa fa-chalkboard-user text-yellow-600"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 640 512"
      >
        <path
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        className="svg-inline--fa fa-location-dot text-blue-600"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 384 512"
      >
        <path
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        data-prefix="fas"
        data-icon="globe"
        className="svg-inline--fa fa-globe text-magenta-600"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
      >
        <path
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        data-prefix="fas"
        data-icon="bacon"
        className="svg-inline--fa fa-bacon text-blue-600"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 576 512"
      >
        <path
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        data-prefix="fas"
        data-icon="cloud"
        className="svg-inline--fa fa-cloud text-green-600"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 640 512"
      >
        <path
  ...
  },
  {
    ...
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 20 20"
        className="svg-inline--fa fa-github text-gray-600"
        fill="currentColor"
        aria-hidden="true"
      >
        <path d="M9.049 3.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 0 0 .95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 0 0-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 0 0-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 0 0-.364-1.118L2.98 9.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 0 0 .951-.69l1.07-3.292z" />
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg
        ...
        data-prefix="fab"
        data-icon="js"
        className="svg-inline--fa fa-js text-yellow-600"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 448 512"
      >
        <path
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        data-prefix="fas"
        data-icon="code"
        className="svg-inline--fa fa-code text-blue-600"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 640 512"
      >
        <path
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        data-prefix="fab"
        data-icon="react"
        className="svg-inline--fa fa-react text-blue-600"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
      >
        <path
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        className="svg-inline--fa fa-layer-group text-green-600"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
      >
        <path
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        className="svg-inline--fa fa-mobile-screen-button text-blue-600"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 384 512"
      >
        <path
  ...
  },
  {
    ...
    svg: (
      <svg
        aria-hidden="true"
        data-prefix="fas"
        data-icon="bars-progress"
        className="svg-inline--fa fa-bars-progress text-indigo-600"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
      >
        <path
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        data-prefix="fas"
        data-icon="bars-progress"
        className="svg-inline--fa fa-bars-progress text-green-600"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
      >
        <path
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        data-prefix="fas"
        data-icon="table"
        className="svg-inline--fa fa-table text-red-600"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
      >
        <path
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        data-prefix="fab"
        data-icon="php"
        className="svg-inline--fa fa-php text-blue-600"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 640 512"
      >
        <path
